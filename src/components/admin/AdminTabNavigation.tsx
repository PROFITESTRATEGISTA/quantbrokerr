...
interface AdminTabNavigationProps {
  activeTab: 'financial' | 'contracts' | 'users' | 'waitlist' | 'suppliers' | 'forms' | 'leads' | 'plans';
  onTabChange: (tab: 'financial' | 'contracts' | 'users' | 'waitlist' | 'suppliers' | 'forms' | 'leads' | 'plans') => void;
}
