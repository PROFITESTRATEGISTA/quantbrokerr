      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-gray-600">Consultorias</p>
              <p className="text-2xl font-bold text-purple-600">{consultationLeads}</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            >
              ...
              <option value="consultation">Formulários de Consultoria</option>
            </select>
          </div>
        </div>
      </div>
