...
import { BarChart3, TrendingUp, Users, DollarSign, Calendar, ToggleLeft, ToggleRight } from 'lucide-react';
...
const FinancialDashboard: React.FC = () => {
  ...
  const [dataType, setDataType] = useState<'users' | 'revenue' | 'costs'>('revenue');
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-6 gap-4">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              value={dataType}
              onChange={(e) => setDataType(e.target.value as 'users' | 'revenue' | 'costs')}
            ...
            <BarChart data={chartData} margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
              ...
              <YAxis 
                ...
                tickFormatter={(value) => 
                  dataType === 'users' 
                    ? value.toString() 
                    : `${config.unit} ${(value / 1000).toFixed(0)}k`
                }
              />
      ...
      <div className="mt-6 grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="text-center">
          ...
          <div className="text-sm text-gray-600">
            Total {dataType === 'users' ? 'Usuários' : dataType === 'revenue' ? 'Receita' : 'Custos'}
          </div>
        </div>
