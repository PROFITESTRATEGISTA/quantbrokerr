/*
  ...
  1. New Tables
    - `supplier_contracts`
      ...
      - `contract_file_url` (text, optional - URL do arquivo no storage)
...
CREATE INDEX IF NOT EXISTS idx_supplier_contracts_supplier_name ON supplier_contracts(supplier_name);
